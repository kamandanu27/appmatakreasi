        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <form action="<?php echo base_url().'progresproyek/update'?>" method="post" enctype="multipart/form-data">

                        
                        <div class="form-group row">
                                <input type="hidden" id="id_progres" name="id_progres" required="required" class="form-control " value="<?= $data['id_progres'] ?>">
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="date" class="form-control" id="tgl_progres" name="tgl_progres" required="required" value="<?= $data['tgl_progres'] ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" id="aktifitas_proyek" name="aktifitas_proyek" required="required" value="<?= $data['aktifitas_proyek'] ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" id="kendala_proyek" name="kendala_proyek" required="required" value="<?= $data['kendala_proyek'] ?>">
                            </div>
                        </div>
