        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <form action="<?php echo base_url().'akun/insert'?>" method="post" enctype="multipart/form-data">

                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Kode Akun</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" id="kode_akun" name="kode_akun" required="required">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" id="nama_akun" name="nama_akun" required="required">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="number" class="form-control" id="saldo_akun" name="saldo_akun" required="required">
                            </div>
                        </div>
